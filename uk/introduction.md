...
Динамічні змінні оголошуються з ключовим словом `var`. Ці змінні можна призначити і перепризначити для різних типів. З іншого боку, `int` та `length` є цілочисельними статично типізованими змінними, які можуть мати цей тип до кінця виконання програми.
