...
Zephir це скорочення слів Z(end) E(ngine)/PH(P)/I(nte)r(mediate). Хоча вимова має звучати як "zephyr", творці Zephir насправді вимовляють його [zaefire](http://translate.google.com/#en/en/zaefire).
