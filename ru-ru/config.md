...
Доступные для расширения глобальные параметры. За дополнительной информацией обратитесь к главе "[Глобальные параметры расширения](/{{ page.version }}/{{ page.language }}/globals)".
